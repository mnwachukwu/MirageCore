...
/// <summary>Ambient world state and the frame-level bookkeeping over it: weather and time of day,
/// animation clocks, and the grid shift on a seamless crossing.</summary>

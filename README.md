...
|---|---|
| [Building a game on Core](docs/building-on-core.md) | What the engine already does, the twenty-one seams a game declares through, and the half-built features that fail silently |

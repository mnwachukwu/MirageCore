...
|---|---|
| [Building a game on Core](docs/building-on-core.md) | What the engine already does, the nineteen seams a game declares through, and the half-built features that fail silently |

...
public static class CorePackets
{
    ...
    public static PacketRegistry.Builder Register(PacketRegistry.Builder builder)
    {
        ...
        builder.Register(PacketNames.MarkerUpdate, Read<MarkerUpdatePacket>);
        ...
        builder.Register(PacketNames.GamePrices, Read<GamePricesPacket>);
        builder.Register(PacketNames.GuildLabels, Read<GuildLabelsPacket>);
